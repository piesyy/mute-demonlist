...
function getUserData(user) {
    ...
    for (var i = 0 ; i < user_data[user].verified.length ; i++) {
        ...
        clears++;
        progresses = progresses + '<li>' + list[rank].name + ' Verified </strong>(#'+(rank+1)+' / UP: '+roundNumber(getUserPoint(rank+1, 200, list[rank].percentToQualify, "144hz")*1, 3) * 2 +')<strong></a></li>'
    }
